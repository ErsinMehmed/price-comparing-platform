         ...
         <div class="col">
            <div class="row">
               <div class="column" onclick="product(event, 'e')">
                  <img src="image/797142555.xiaomi-poco-x3-pro-256gb-8gb-ram-dual.jpg" alt="iPhone 12 64GB" onclick="imgChange(this);">
               </div>
               <div class="column" onclick="product(event, 'p')">
                  <img class="tab" src="image/1088790.xiaomi-poco-x3-pro-256gb-8gb-ram-dual.jpg" alt="headphones" onclick="imgChange(this);">
               </div>
               <div class="column" onclick="product(event, 't')">
                  <img class="tab2" src="image/1088823.xiaomi-poco-x3-pro-256gb-8gb-ram-dual.jpg" alt="treadmill" onclick="imgChange(this);">
               </div>
               <div class="column" onclick="product(event, 'a')">
                  <img class="tab" src="image/1088814.xiaomi-poco-x3-pro-256gb-8gb-ram-dual.jpg" alt="coffee machine" onclick="imgChange(this);">
               </div>
            </div>
            <div class="containerf">
               <div class="expandedImge"><img id="expandedImg" src="image/1088790.xiaomi-poco-x3-pro-256gb-8gb-ram-dual.jpg" width="313px" height="261px"></div>
            </div>
            ...
            <div class="midlle">
               <div class="textt">Xiaomi Poco X3 Мобилни телефони</div>
               <div class="stars">
                  ...
                  <span class="oc"> (4,3)</span>
               </div>
               <div class="price" id="price">Цена от 1 130,00лв</div>
               <div class="gb" id="gb">Варианти на продукта: <span onclick="GBB()"><span onclick="GBs()"><button onclick="openCity(event, 'London')" class="btnn">64GB</button></span></span><span onclick="GBW()"><span onclick="GB()"><button class="btnn" onclick="openCity(event, 'Paris')">128GB</button></span></span><span onclick="GBD()"><span onclick="GBt()"><button class="btnn" onclick="openCity(event, 'Tokyo')">256GB</button></span></span></div>
               <div class="roww">
               ...
               <script>
                  function GBB() {
                     document.getElementById("gbb").innerHTML = "64GB";
                  };
         ...
         <div class="warpper">
            ...
            <div class="panels">
               <div class="panel" id="one-panel">
                  <div class="offer">Оферти за <span>Xiaomi Poco X3 Pro 64GB (8 оферти)</span></div>
                  <div class="offerBody">
                     ...
                     <div class="name">
                        <div class="namee"><a target="blank" href="https://www.buybest.bg/apple-iphone-13-128gb">Xiaomi Poco X3 Pro 64GB</a></div>
                        <div class="gar">Нови, Оригинални, Запечатани с 24 Месеца Гаранция | Лизинг</div>
                     </div>
                     <div class="pricee">
                        <div class="lv"><a target="blank" href="https://www.buybest.bg/apple-iphone-13-128gb">1 130,00лв</a></div>
                  ...
                  <div class="offerBody">
                     ...
                     <div class="name">
                        <div class="namee"><a href="">Xiaomi Poco X3 Pro 64GB</a></div>
                        <div class="gar">Оригинален продукт! Гаранция! Пълен комплект!</div>
                     </div>
                     <div class="priceee">
                        <div class="lv"><a href="">1 190,00лв</a></div>
                        <div class="availability" id="tooltip">В наличност <span class="tooltiptext">Стоката е налична. Магазинът може да я достави днес или на следващия работен ден.</span></div>
                     </div>
                     <div class="bttn">
                  ...
                  <div class="offerBody">
                     ...
                     <div class="name">
                        <div class="namee"><a href="">Xiaomi Poco X3 64GB</a></div>
                        <div class="gar"></div>
                     </div>
                     <div class="priceeeeе">
                        <div class="lv"><a href="">1 245,00лв</a></div>
                        <div class="availability" id="tooltip">В наличност<span class="tooltiptext">Стоката е налична. Магазинът може да я достави днес или на следващия работен ден.</span></div>
                     </div>
                     <div class="bttn">
                        <a class="bttnn" href="">Към магазина ></a>
                  ...
                  <div class="offerBody">
                     ...
                     <div class="name">
                        <div class="namee"><a target="blank" href="">Xiaomi Poco X3 Pro 64GB</a></div>
               ...
               <div class="panel d-none" id="three-panel">
                  ...
                  <div class="commSection">
                     ...
                     ?>
                           <div class="boxxx">
                              <div class="nammee"><span>Име: </span><?php echo $row['name']; ?>: <?php $date = date("j F Y");
                                                                                                   echo $date; ?></div>
                              <div class="bo"></div>
