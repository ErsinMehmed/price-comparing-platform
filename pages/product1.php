   ...
   <section id="sec">
         ...
         <div class="warpper">
            ...
            <div class="panels">
               ...
               <div class="panel d-none" id="three-panel">
                  ...
                  <div class="login">
                     <div class="head">Влезте в профила си за да може да добавите коментар</div>
                     <div class="al"><a href="reg.php">Към вход</a></div>
                  </div>
      ...
      <div id="Paris" class="tabcontent">
         ...
         <div id="third" class="tabcontentc">
            ...
            <div class="login">
               <div class="headd">Влезте в профила си за да може да добавите коментар</div>
               <div class="al"><a href="reg.php">Към вход</a></div>
            </div>
            <div class="commSection">
               <?php
